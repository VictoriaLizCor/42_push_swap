...
/*   Updated: 2023/03/01 16:38:20 by lilizarr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	divide_sort(t_stack **stack_a, t_stack **stack_b, int max_s_idx)
{
	...
	while (find_min_value((*stack_a), &((*stack_a)->s_idx)) < mid && size > 3)
	{
...
void	sorting_algorithm(t_stack **stack_a, t_stack **stack_b)
{
	...
	size = max_s_idx;
	i = 1;
	while ((!check_sorted(*stack_a) || size != max_s_idx))
	{
		if (size > 3)
